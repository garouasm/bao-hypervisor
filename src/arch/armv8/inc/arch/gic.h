...
#define GICD_TYPER_CPUNUM_MSK \
    BIT_MASK(GICD_TYPER_CPUNUM_OFF, GICD_TYPER_CPUNUM_LEN)
...
#define GICD_TYPER_IDBITS_MSK \
    BIT_MASK(GICD_TYPER_IDBITS_OFF, GICD_TYPER_IDBITS_LEN)
...
#define ICC_SGIR_TRGLSTFLT_MSK \
    BIT_MASK(ICC_SGIR_TRGLSTFLT_OFF, ICC_SGIR_TRGLSTFLT_LEN)
